[https://medium.com/@migueldoctor/run-mysql-phpmyadmin-locally-in-3-steps-using-docker-74eb735fa1fc](https://medium.com/@migueldoctor/run-mysql-phpmyadmin-locally-in-3-steps-using-docker-74eb735fa1fc)
...
`docker run --name my-own-phpmyadmin -d --link my-own-mysql:db -p 8080:80 phpmyadmin/phpmyadmin`
